                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <c:if test="${baoxiao.bxstatus==0 or baoxiao.bxstatus==1}">
	                                        	...
	                                        	<button value="${baoxiao.bxid}" type="button" class="btndel">撤销</button>
                                            </c:if>
                                        </td>
                                    </tr>
                                </c:forEach>
                       ...
                       <div class="row">
                           ...
                           <div class="col-sm-12 text-right">
                               <div class="btn-group">
                                   ...
                                   <a href="/baoxiao/list&pageNum=${page.pageNum-1}&type=${type}&keyword=${keyword}" type="button" class="btn btn-sm btn-white <c:if test="${page.pageNum-1<1}">disabled</c:if> "><i class="glyphicon glyphicon-chevron-left"></i>
                                   </a>
                                   <c:forEach begin="1" end="${page.pages}" varStatus="vs">

                                       <a href="/baoxiao/list&pageNum=${vs.index}&type=${type}&keyword=${keyword}" class="btn btn-sm btn-white    <c:if test="${page.pageNum==vs.index}">active</c:if> ">${vs.index}</a>
                                   </c:forEach>

                                   <a href="/baoxiao/list&pageNum=${page.pageNum+1}&type=${type}&keyword=${keyword}" type="button" class="btn btn-sm btn-white <c:if test="${page.pageNum+1>page.pages}">disabled</c:if>"><i class="glyphicon glyphicon-chevron-right"></i>
                                   </a>
                               </div>
                           </div>
                       </div>
