                    ...
                    <div class="ibox-content">
                        ...
                        <div class="row">
                            <div class="form-group">
                                ...
                                <div class="col-sm-3">
                                   <input name="comname" type="text" class="form-control input-sm required">
                                </div>
                        ...
                        <div class="row">
                            <div class="form-group">
                                ...
                                <div class="col-sm-3">
                                   <input name="comphone" type="text" class="form-control input-sm required">
                                </div>
                                <label class="col-sm-2  col-sm-offset-1 control-label ">座机</label>
                                <div class="col-sm-3">
                                    <input name="camera" type="text" class="form-control input-sm required">
                                </div>
                            </div>
                        </div>
                        <div class="row">
   ...
   <script>
	$(document).ready(function() {
	    ...
	    $(".btnSave").click(function () {
            ...
            $.post("/customer/save",data,function (result) {
